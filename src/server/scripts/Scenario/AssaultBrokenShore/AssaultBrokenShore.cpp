...
struct npc_broken_shore_misc : ScriptedAI
{
    npc_broken_shore_misc(Creature* creature) : ScriptedAI(creature) 
    {
...
// 118517
struct npc_arcane_raven : ScriptedAI
{
    npc_arcane_raven(Creature* creature) : ScriptedAI(creature) {}
...
// 118558 120743
struct npc_bs_legion_portal : ScriptedAI
{
    npc_bs_legion_portal(Creature* creature) : ScriptedAI(creature) 
    {
...
// 267955
struct go_bs_demoic_gates : public GameObjectAI
{
...
class playerscript_intro_assault : public PlayerScript
{
public:
    playerscript_intro_assault() : PlayerScript("playerscript_intro_assault") { }
...
{
    RegisterCreatureAI(npc_broken_shore_misc);
    RegisterCreatureAI(npc_arcane_raven);
    RegisterCreatureAI(npc_bs_legion_portal);

    RegisterGameObjectAI(go_bs_demoic_gates);

    RegisterPlayerScript(player_scripts_for_start_assault);
    RegisterPlayerScript(playerscript_intro_assault);
};