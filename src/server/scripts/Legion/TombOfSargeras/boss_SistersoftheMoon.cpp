    ...
    void DoAction(int32 const actionID) override
    {
        switch (actionID)
        {
            case ACTION_1:
                ...
                break;
            case ACTION_4:
                if ((phase == 2 && IsHeroicPlusRaid()) || phase == 3)
    ...
    void DoAction(int32 const actionID) override
    {
        switch (actionID)
        {
            ...
            case ACTION_3:
                ...
                break;
            case ACTION_4:
                if ((phase == 1 && IsHeroicPlusRaid()) || phase == 2)
    ...
    void DoAction(int32 const actionID) override
    {
        switch (actionID)
        {
            ...
            case ACTION_2:
                ...
                break;
            case ACTION_3:
                if (phase == 1 || (phase == 3 && IsHeroicPlusRaid()))
