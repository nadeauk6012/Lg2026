...
struct npc_q40077_1 : public ScriptedAI
{
    npc_q40077_1(Creature* creature) : ScriptedAI(creature)
    {
        timer = 0;
        movein = false;
    }
...
// 241751
struct go_q40378 : public GameObjectAI
{
    go_q40378(GameObject* go) : GameObjectAI(go)
    {
...
struct go_q39279 : public GameObjectAI
{
    go_q39279(GameObject* go) : GameObjectAI(go)
    {
...
class spell_legion_q39279 : public SpellScript
{
    PrepareSpellScript(spell_legion_q39279);
    ...
    {
        OnEffectHitTarget += SpellEffectFn(spell_legion_q39279::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
struct conversation_announcer : public ScriptedAI
{
    conversation_announcer(Creature* creature) : ScriptedAI(creature)
    {
...
struct npc_q39049 : public Scripted_NoMovementAI
{
    npc_q39049(Creature* creature) : Scripted_NoMovementAI(creature), summons(me), phase2(false)
    {
...
struct go_q38759 : public GameObjectAI
{
    go_q38759(GameObject* go) : GameObjectAI(go)
    {
...
struct go_q40379 : public GameObjectAI
{
    go_q40379(GameObject* go) : GameObjectAI(go)
    {
...
//243335
struct go_q39050 : public GameObjectAI
{
    go_q39050(GameObject* go) : GameObjectAI(go)
    {
...
//241757
struct go_q38765 : public GameObjectAI
{
    go_q38765(GameObject* go) : GameObjectAI(go)
    {
...
struct npc_q93221_beliash : public Scripted_NoMovementAI
{            
    EventMap events;
    ObjectGuid playerGuid;
    ObjectGuid TyrannaGuid;

    npc_q93221_beliash(Creature* creature) : Scripted_NoMovementAI(creature)
    {
        creature->SetCorpseDelay(30);
        creature->SetRespawnDelay(15);
...
//96441 Fel Lord Caza
struct npc_q39495_caza : public ScriptedAI
{
    EventMap events;
    ObjectGuid playerGuid;

    npc_q39495_caza(Creature* creature) : ScriptedAI(creature)
    {
        creature->SetCorpseDelay(30);
        creature->SetRespawnDelay(15);
    }
...
// Q: 38727
struct go_q38727 : public GameObjectAI
{
    go_q38727(GameObject* go) : GameObjectAI(go)
    {
...
//103429
struct npc_q40222_progres1 : public ScriptedAI
{
    npc_q40222_progres1(Creature* creature) : ScriptedAI(creature)
    {
        SetCanSeeEvenInPassiveMode(true);
    }
...
struct npc_q39495_prolifica : public Scripted_NoMovementAI
{
    EventMap events;
    ObjectGuid playerGuid;

    npc_q39495_prolifica(Creature* creature) : Scripted_NoMovementAI(creature)
    {
        creature->SetCorpseDelay(30);
        creature->SetRespawnDelay(15);
...
//93802 tyranna
struct npc_q38728_tyranna : public ScriptedAI
{
    EventMap events;
    ObjectGuid playerGuid;
    ...
    npc_q38728_tyranna(Creature* creature) : ScriptedAI(creature), healthPct(0), summons(me), count(0)
    {
        creature->SetCorpseDelay(30);
        creature->SetRespawnDelay(15);
    }
...
//101760
struct npc_q38728_progres1 : public ScriptedAI
{
    npc_q38728_progres1(Creature* creature) : ScriptedAI(creature)
    {
        SetCanSeeEvenInPassiveMode(true);
    }
...
//245728
struct go_q38729 : public GameObjectAI
{
    go_q38729(GameObject* go) : GameObjectAI(go)
    {
...
// 245045
struct go_q39262 : public GameObjectAI
{
    go_q39262(GameObject* go) : GameObjectAI(go), ow(nullptr)
    {
        check = false;
        timer = 0;
    }
...
// 99916
struct npc_q40378_1 : public ScriptedAI
{
    npc_q40378_1(Creature* creature) : ScriptedAI(creature)
    {
        check = false;
    }
...
struct npc_q40378_2 : public ScriptedAI
{
    npc_q40378_2(Creature* creature) : ScriptedAI(creature), timer(0)
    {
        check = false;
    }
...
struct npc_q38759_1 : public ScriptedAI
{
    npc_q38759_1(Creature* creature) : ScriptedAI(creature) { }
...
// 99917
struct npc_q40379_2 : public ScriptedAI
{
    npc_q40379_2(Creature* creature) : ScriptedAI(creature) { }
...
struct npc_96654 : public ScriptedAI
{
    npc_96654(Creature* creature) : ScriptedAI(creature) { }
...
struct npc_q39495 : public ScriptedAI
{
    npc_q39495(Creature* creature) : ScriptedAI(creature)
    {
        check = false;
        timer = 0;
    }
...
// 93762 96732 96731
struct npc_q38727 : public ScriptedAI
{
    npc_q38727(Creature* creature) : ScriptedAI(creature)
    {
        check1 = false;
        check2 = false;
        timer = 0;
...
struct npc_c100161 : public ScriptedAI
{
    npc_c100161(Creature* creature) : ScriptedAI(creature)
    {
        me->SetReactState(REACT_PASSIVE);
        me->setActive(true);
    }
...
void AddSC_Mardum()
{
    RegisterSceneScript(sceneTrigger_dh_init);
    ...
    RegisterCreatureAI(npc_q40077_1);
    RegisterCreatureAI(conversation_announcer);
    RegisterCreatureAI(npc_q39049);
    RegisterCreatureAI(npc_q93221_beliash);
    RegisterCreatureAI(npc_q39495_caza);
    RegisterCreatureAI(npc_q40222_progres1);
    RegisterCreatureAI(npc_q39495_prolifica);
    RegisterCreatureAI(npc_q38728_tyranna);
    RegisterCreatureAI(npc_q38728_progres1);
    RegisterCreatureAI(npc_q40378_1);
    RegisterCreatureAI(npc_q40378_2);
    RegisterCreatureAI(npc_q38759_1);
    RegisterCreatureAI(npc_q40379_2);
    RegisterCreatureAI(npc_96654);
    RegisterCreatureAI(npc_q39495);
    RegisterCreatureAI(npc_q38727);
    RegisterCreatureAI(npc_c100161);

    RegisterGameObjectAI(go_q40077);
    RegisterGameObjectAI(go_q40378);
    RegisterGameObjectAI(go_q39279);
    RegisterGameObjectAI(go_q38759);
    RegisterGameObjectAI(go_q40379);
    RegisterGameObjectAI(go_q39050);
    RegisterGameObjectAI(go_q38765);
    RegisterGameObjectAI(go_q38727);
    RegisterGameObjectAI(go_q38729);
    RegisterGameObjectAI(go_q39262);

    RegisterSpellScript(spell_legion_q39279);
}